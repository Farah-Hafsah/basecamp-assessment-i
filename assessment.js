...
var myName = "Farah-Hafsah"; // CODE HERE
...
console.log(responseCreator("red")); // CODE HERE
...
function greeter(array) {
	...
	number = 54;
	var total;
	total = array[0] + name + array[1] + number + array[2];
	return total;
}
var yo = greeter(["Hi! I am ", " and I am ", " years old"]);
console.log(yo);
// CODE HERE
